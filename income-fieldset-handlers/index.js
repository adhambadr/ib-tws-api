...
export default {
  ...
  [IncomeMessageType.OPEN_ORDER_END]: function (fields) {
    this.messageTypeResolve(IncomeMessageType.OPEN_ORDER_END, this.messageTypeStorageArray(IncomeMessageType.OPEN_ORDER_END));
  },
  ...
  [IncomeMessageType.POSITION_END]: function (fields) {
    this.messageTypeResolve(IncomeMessageType.POSITION_END, this.messageTypeStorageMap(IncomeMessageType.POSITION_END));
  },
